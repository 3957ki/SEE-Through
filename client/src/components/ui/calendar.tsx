    ...
    <div className="flex items-center justify-between px-1 mb-4 relative z-10">
      ...
      <div className="flex">
        ...
        <CustomDropdown
          ...
          className="w-28"
          buttonClassName="px-4 py-2 text-base font-bold bg-background hover:bg-accent hover:text-accent-foreground rounded-md"
          dropdownClassName="w-28 bg-popover shadow-md max-h-[200px] overflow-y-auto"
          optionClassName="px-4 py-2 text-base hover:bg-accent hover:text-accent-foreground"
        />
        ...
        <CustomDropdown
          ...
          className="w-28"
          buttonClassName="px-4 py-2 text-base font-bold bg-background hover:bg-accent hover:text-accent-foreground rounded-md"
          dropdownClassName="w-28 bg-popover shadow-md"
          optionClassName="px-4 py-2 text-base hover:bg-accent hover:text-accent-foreground"
        />
      </div>
